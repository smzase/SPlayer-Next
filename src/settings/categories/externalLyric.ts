...
const taskbarLyricSection: SettingSection = {
  ...
  items: [
    ...
    {
      key: "taskbarLyricQueueWidth",
      type: "slider",
      binding: { store: "settings", path: "system.taskbarLyric.queueWidth" },
      min: 280,
      max: 600,
      step: 20,
      defaultValue: 340,
      marks: { 280: "280", 340: "340", 480: "480", 600: "600" },
    },
    {
      key: "taskbarLyricQueueHeight",
      type: "slider",
      binding: { store: "settings", path: "system.taskbarLyric.queueHeight" },
      min: 360,
      max: 800,
      step: 20,
      defaultValue: 520,
      marks: { 360: "360", 520: "520", 680: "680", 800: "800" },
    },
    {
    ...
    {
      key: "taskbarLyricTranslationFontWeight",
      type: "slider",
      binding: { store: "settings", path: "system.taskbarLyric.translationFontWeight" },
      min: 100,
      max: 900,
      step: 100,
      defaultValue: 400,
    ...
    {
      key: "taskbarLyricSeparateCoverAndLyric",
      type: "switch",
    ...
    {
      key: "taskbarLyricAutoGenerateWordByWord",
      type: "switch",
      binding: { store: "settings", path: "system.taskbarLyric.autoGenerateWordByWord" },
      defaultValue: true,
      disabled: () => !useSettingsStore().system.taskbarLyric.wordByWord,
    },
    {
